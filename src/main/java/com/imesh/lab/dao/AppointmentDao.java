...
public interface AppointmentDao {
    ...
    public boolean addNewAppointment(AddAppointmentModel addAppointmentModel, Timestamp date, int id, int payment_id) throws SQLException, ClassNotFoundException, ParseException;
}
